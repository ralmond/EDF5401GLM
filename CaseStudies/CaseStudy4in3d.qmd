...
$$\sigma_{ij} = E\left [(X_i-\mu_i)(X_i-\mu_j)\right ]$$ Diagonal
...
\sum (x_{11}-\bar{x_1})^2 & (x_{11}-\bar{x_1})(x_{12}-\bar{x_2}) & \ldots &
(x_{11}-\bar{x_1})(x_{1p}-\bar{x_p}) \\
\sum (x_{12}-\bar{x_2})(x_{11}-\bar{x_1}) & (x_{12}-\bar{x_2})^2 & \ldots &
(x_{12}-\bar{x_2})(x_{1p}-\bar{x_p}) \\
\vdots & \vdots & \ddots & \vdots \\
\sum (x_{1p}-\bar{x_p})(x_{11}-\bar{x_1}) & (x_{1p}-\bar{x_p})(x_{12}-\bar{x_2}) & \ldots &
(x_{1p}-\bar{x_p})^2
\end{array}\right]$$
...
Then
$\boldsymbol{\Sigma}=\boldsymbol{\sigma}\boldsymbol{P}\boldsymbol{\sigma}$
...
Then $$X_1 + X_2 \approx (1-c)X_1 + (1+c)X_2$$ \## Fixing colinearity
